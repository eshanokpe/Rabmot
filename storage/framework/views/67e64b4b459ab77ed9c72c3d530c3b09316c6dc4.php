                ...
                <div class="slider-items-wrap">
                    <div class="slider-inner">
                        ...
                        <div class="slider-img">
                            <img src="assets/img/slider/h2-slider-03.png" alt="img">
                        </div>
                        <!--// Slider Img-->
                    </div>
                    <!--// Slider Inner-->
                    ...
                    <div class="slider-content-bottom">
                        <div class="car-model">
                            <div class="items">
                                <div class="items__icon"><i class="flaticon-speedometer"></i></div>
                            ...
                            <div class="items">
                                <div class="items__icon"><i class="flaticon-engine"></i></div>
                                <div class="items__content">
                            ...
                            <div class="items">
                                <div class="items__icon"><i class="flaticon-fuel-station"></i></div>
                                <div class="items__content">
                ...
                <div class="col-lg-12">
                    <div class="tab-wrapper">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="all-tab" data-toggle="tab" href="#all" role="tab">All car
                                    types</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="new-car" data-toggle="tab" href="#newcar" role="tab">New car</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="use-car" data-toggle="tab" href="#usecar" role="tab">Usde
                                    car</a>
                            </li>
                        </ul>
                        <!-- Tab panes -->
                                ...
                                <div class="select-box-wrap">
                                    ...
                                    <div class="items">
                                        <div class="main-btn-wrap text-center">
                                            <a href="#" class="main-btn uppercase">FIND CAR</a>
                                        </div>
                                    </div>
                                    <!--// Items-->
                                </div>
                    ...
                    <div class="section-border-image margin-left white-gray">
                        <div class="border-design">
                            ...
                            <div class="we-are-img">
                                <img src="assets/img/home-02/01.png" alt="img">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12 px-0">
                    ...
                    <div class="section-title text-center">
                        <div class="padding-bottom-15">
                            <h6 class="title both-line uppercase gray"> Check Out Our Recent Cars </h6>
                        </div>
                        <h2 class="heading-02 padding-bottom-70">Featured Vehicles</h2>
                    </div>
                    <!--// Section Title End-->
                </div>
            </div>
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;<?php /**PATH C:\xampp\htdocs\laravel\rabmot\resources\views/welcome.blade.php ENDPATH**/ ?>