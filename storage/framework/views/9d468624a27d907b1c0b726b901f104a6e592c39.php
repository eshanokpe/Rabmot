        ...
        <div class="row no-gutters">
            <div class="message-popup__wrapper">
                ...
                <div class="message-popup__form">
                    <form action="http://zwin.io/html/coche/index.html" class="contact-form">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                ...
                                <div class="slider-items-wrap">
                                    <div class="slider-inner">
                                        <div class="slider-content">
                                            <div class="slider-content-inner">
                                                ...
                                                <div class="slider-title">
                                                    <h1 class="heading-01">Mercedes-AMG GT <span class="bold">4-Door
                                                            Coupe</span></h1>
                                                </div>
                                                <!--// Slider Title End-->
                                        ...
                                        <div class="slider-img">
                                            <img src="assets/img/slider/h2-slider-01.png" alt="img">
                                        </div>
                                        <!--// Slider Img-->
                                    </div>
                                    <!--// Slider Inner-->
                                    ...
                                    <div class="slider-inner">
                                        <div class="slider-content">
                                            <div class="slider-content-inner">
                                                ...
                                                <div class="slider-title">
                                                    <h1 class="heading-01">Mercedes-AMG GT <span class="bold">63 s
                                                            4matic+</span></h1>
                                                </div>
                                                <!--// Slider Title End-->
...
<?php /**PATH C:\xampp\htdocs\laravel\rabmot\resources\views/layouts/app.blade.php ENDPATH**/ ?>