			...
			<div class="page-content">
						...
						<div class="ps-3">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb mb-0 p-0">
									<li class="breadcrumb-item"><a href="{{ route('agent.dashboard') }}"><i class="bx bx-home-alt"></i></a>
									</li>
				...
				<div class="row">
					...
					<div class="col-12 col-lg-3">
						<a href="{{ route('agent.addVehicleRenewal')}}">
					...
					<div class="col-12 col-lg-3 ">
						<a href="{{ route('agent.addVehicleRegistration')}}">
						<div class="card radius-15 w-100 text-center border-primary">
							<div class="card-body">
					...
					<div class="col-12 col-lg-3 ">
						<a href="{{ route('agent.addVehicleOwnership')}}">
						<div class="card radius-15 w-100 text-center border-primary">
							<div class="card-body">
