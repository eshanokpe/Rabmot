						...
						<div class="ps-3">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb mb-0 p-0">
									<li class="breadcrumb-item"><a href="#"><i class="bx bx-car"></i></a>
									</li>
						...
						<div class="col-xl-10 mx-auto">
							...
							<div class="card border-top border-0 border-4 border-primary">
								<div class="card-body p-5">
									<form class="row g-3" method="POST" action="{{ route('agent.postAddVehicleOwnership') }}" enctype="multipart/form-data">
										@csrf
										 <div class="col-md-12">
