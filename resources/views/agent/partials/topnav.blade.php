        ...
        <div class="right-topbar ms-auto">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown dropdown-lg">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href=" {{ route('agent.cart') }}" >	
                        @php
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <div class="header-notifications-list ps">
                            @forelse ($notifications as $notification)
                                <a class="dropdown-item" href="{{ route('agent.notifications.markAsRead', $notification->id) }}">
                    ...
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-bs-toggle="dropdown">
                        ...
                        <div class="d-flex user-box align-items-center">
                            ...
                            @if($profileImage != null)
                                <img src="{{ asset('/assets/profileimages/'.$profileImage) }}" id="image_preview_container" class="user-img" alt="user avatar" />
                            @else
