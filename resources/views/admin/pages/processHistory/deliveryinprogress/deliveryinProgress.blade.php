                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"> Delivery in Progress Document</h3>
                            </div>
                                        ...
                                        @forelse ($items as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endif
                                                    @if( $item->status == '3')
                                                        <h4><center><span class="badge badge-success delivery "> Delivery in Progress</span></center></h4>
                                                    @endif 
                                                    @if( $item->status == '4')
                                                ...
                                                <td class="text-end">
                                                    <span class="dropdown">
                                                        <a href="{{ route('admin.viewdeliveryinprogress', encrypt($item->id)) }}" class="btn align-text-top">Actions</a>
                                                    </span>
                                                </td>
                                            </tr>
                                        @empty
