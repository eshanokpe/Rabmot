            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    <div class="col">
                        ...
                        <h2 class="page-title">
                            Edit Ready for Delivery Document Admin
                        </h2>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Ready for Delivery Document</h3>
                            </div>
                            <br>
                            @if(session('success'))
                            ...
                            <div class="col-6 mt-2 ps-2">
                                <form class="form-fieldset" action="{{ route('admin.update-readyfordelivery-status', ['id' => encrypt($items->id) ]) }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-6">
                                            <a href="{{ route("admin.readyfordelivery") }}" class="btn btn-primary ms-auto">Back</a>  
                                        </div>                                  
                                    </div>
                                </form>
                            </div>         
