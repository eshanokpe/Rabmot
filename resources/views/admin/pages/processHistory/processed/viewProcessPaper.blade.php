                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Process Document</h3>
                            </div>
                            <br>
                            @if(session('success'))
                            ...
                            <div class="col-6 mt-2 ps-2">
                                <form class="form-fieldset" action="{{ route('admin.update-processPaper-status', ['id' => encrypt($items->id)]) }}" method="POST">
                                    @csrf
                                    @method('PUT')    
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-6">
                                            <a href="{{ route("admin.processedpaper") }}" class="btn btn-primary ms-auto">Back</a>  
                                        </div>                                  
                                    </div>
                                </form>
                            </div>         
