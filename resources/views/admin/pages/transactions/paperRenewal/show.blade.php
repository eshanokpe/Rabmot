            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    <div class="col">
                        ...
                        <h2 class="page-title">
                             Transaction Vehicle Paper Renewal  Details
                        </h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Transaction Vehicle Paper Renewal Details</h3>                           
                            </div>
                            @if(session('error'))
                                ...
                                <fieldset class="form-fieldset">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-6">
                                            ...
                                            <a href="{{route('admin.transaction.paperRenewal')}}"><button  class="btn btn-primary ms-auto">Back</button></a>    
