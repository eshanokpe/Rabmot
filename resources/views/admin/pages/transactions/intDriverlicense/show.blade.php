            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    <div class="col">
                        ...
                        <h2 class="page-title">
                            View transaction international driver license details
                        </h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Transaction international driver license details</h3>                           
                            </div>
                            @if(session('error'))
                                ...
                                <fieldset class="form-fieldset">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-6">
                                            <a href="{{route('admin.transactions.internationalDriverLicense')}}" class="btn btn-primary ms-auto">Back</a>    
                                        </div>
                                    </div>                                   
                                </fieldset>
                            </div>
