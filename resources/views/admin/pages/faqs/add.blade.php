                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-12 mt-2 ps-2">
                                <form class="form-fieldset" action="{{ route('admin.faq.add') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-6">
                                                    ...
                                                    <textarea name="answer" class="form-control" autocomplete="off" rows="8"></textarea>
                                                </div>
                                                <div class="mb-3 col-3">
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <label class="form-label">   .</label>
                                                    <button type="submit" class="btn btn-primary ms-auto">Add FAQ</button>    
                                                </div>
                                                <div class="mb-3 col-3">
                                                </div>
                                            </div>
