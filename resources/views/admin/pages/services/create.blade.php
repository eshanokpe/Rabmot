                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-12 mt-2 ps-2">
                                <form class="form-fieldset" method="POST" action="{{ route('admin.services.store') }}">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-4">
                                            ...
                                            <input type="number" step="0.01" min="0" max="100" name="commission_rate_override" class="form-control" value="{{ old('commission_rate_override') }}"/>
                                        ...
                                        <div class="mb-3 col-12">
                                            <label class="form-check">
                                                <input type="checkbox" class="form-check-input" name="commission_eligible" value="1" {{ old('commission_eligible', true) ? 'checked' : '' }}>
