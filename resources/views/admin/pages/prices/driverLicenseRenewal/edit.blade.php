            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="text-end col-6">
                        <a href="{{route("admin.driverLicenseRenewal.index")}}">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Driver License Renewal Price</h3>
                            </div>
                             @if(session('success'))
                            ...
                            <div class="col-12 mt-2 ps-2">
                                <form action="{{ route("admin.driverLicenseRenewal.update", $data->id) }}" method="POST">
                                     @csrf 
                                     @method('PUT')
                                    <div class="row">
                                        <div class="col-2">
                                        ...
                                        <div class="col-7">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="yearType" class="form-control" value="{{ $data->years_type}}" autocomplete="off"/> 
                                            </div>
                                            <div class="mb-3">
