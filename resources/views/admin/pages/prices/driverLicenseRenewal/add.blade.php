            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="text-end col-6">
                        <a href="{{ route("admin.driverLicenseRenewal.index") }}" class="btn btn-primary">
                           View Driver License Renewal Price
                        </a> 
                    </div>
                </div>
            </div>
                ...
                <div class="row row-deck row-cards">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Driver License Renewal Price</h3>
                            </div>
                             @if(session('success'))
                            ...
                            <form action="{{ route("admin.driverLicenseRenewal.store") }}" method="POST" >
                                @csrf 
                                <div class="row">
                                        <div class="col-4">
