                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">+Add Vehicle Change of Ownership</h3>
                            </div>
                            <br>
                            @if (session('success'))
							<div class="col-sm-12">
                            ...
                            <div class="col-12 mt-2 ps-2">
                                <fieldset class="form-fieldset">
                                    <form class="row g-3" method="POST" action="{{ route('admin.vehicle.changeOfOwnership.store') }}" enctype="multipart/form-data">
										@csrf
										...
										<div class="col-sm-6 col-md-4">
											...
											<input required type="text" class="form-control" name="enginenumber" id="enginenumber" placeholder="Engine Number ">
											@error('enginenumber')
											<span class="text-danger">{{ $message }}</span>
											@enderror
										</div>
                                        ...
                                        <div class="col-sm-6 col-md-6">
											...
											<input required type="text" class="form-control" name="vehiclepaper" id="enginenumber" placeholder=" Name on Vehicle Paper"> 
											@error('vehiclepaper')
												<span class="text-danger">{{ $message }}</span>
											@enderror
										</div>
                                        ...
                                        <div class="col-sm-6 col-md-6">
										 ...
										 <div class="col-sm-6 col-md-6">
											...
											<input required type="number" class="form-control" name="ownerNIN" id="ownerNIN" placeholder="Owners NIN"> 
											@error('ownerNIN')
												<span class="text-danger">{{ $message }}</span>
											@enderror
										</div>
