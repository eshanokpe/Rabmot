        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        Vehicles Paper Renewal Process
                    </h2>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"> Vehicles Paper Renewal </h3>
                        </div>
                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <span class="dropdown">
                                                <a href="{{route('admin.viewVehiclePaperRenewal', encrypt($item->id) )}}" class="btn ">View</a> 
                                            </span>
                                        </td> 
