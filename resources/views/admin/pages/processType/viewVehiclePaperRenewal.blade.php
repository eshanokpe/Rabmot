            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    <div class="col">
                        ...
                        <h2 class="page-title">
                            View Vehicle Paper Renewal Process Details
                        </h2>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <h3 class="card-title"> View Vehicle Paper Renewal Process</h3>
                                ...
                                <fieldset class="form-fieldset">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-3">
                                            ...
                                            <input type="text" class="form-control" autocomplete="off" value="{{ $items->vehicleType}}" disabled/>
                                        </div>
                                        <div class="mb-3 col-3">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" autocomplete="off" value="{{ $items->roadWorthiness}}" disabled/>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-3">
                                            <label class="form-label">Third Party Insurance</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" autocomplete="off" value="{{ $items->thirdPartyInsurance}}" disabled/>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-3">
                                        ...
                                        <div class="mb-3 col-3">
                                            <label class="form-label">Vehicle Inspection Pick and drop</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" autocomplete="off" value="{{ $items->vehicleInspectionPickanddrop}}" disabled/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-3 col-6">
                                            <a href="{{route('admin.processVehiclePaperRenewal')}}"><button  class="btn btn-primary ms-auto">Back</button></a>    
                                        </div>
                                    </div>                                   
