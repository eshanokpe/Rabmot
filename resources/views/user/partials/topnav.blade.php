    ...
    <nav class="navbar navbar-expand">
        ...
        <div class="right-topbar ms-auto">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown dropdown-lg">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative show" href="javascript:;" data-bs-toggle="dropdown" aria-expanded="true">	<i class="bx bx-bell vertical-align-middle"></i>
                ...
                <li class="nav-item dropdown dropdown-user-profile">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">	
                        ...
                        <a class="dropdown-item" href="{{ route('home.profile') }}"><i
                        ...
                        <a class="dropdown-item" href="{{ route('home.processHistory') }}"><i

                                class="bx bx-file"></i><span>Process History</span></a>

                        
                        <a class="dropdown-item" href="{{ route('home.transactionHistory') }}"><i
