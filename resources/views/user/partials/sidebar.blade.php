<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
		    ...
		    <ul>
				<li> 
				    <a href="{{ route('home.vehicleRenewalPaper') }}"><i class="bx bx-right-arrow-alt"></i>Vehicle Paper Renewal  </a> 
				</li>
				<li>
				     <a href="{{ route('home.newVehicleRegistration')}}"><i class="bx bx-right-arrow-alt"></i>New Vehicle Registration</a>
				</li>
				<li> 
				    <a href="{{ route('home.changeofOwnership') }}"><i class="bx bx-right-arrow-alt"></i>Change of Ownership</a></a>
				</li>
				<li>
				   <a href="{{ route('home.platenumber')}}"><i class="bx bx-right-arrow-alt"></i>Dealer's Plate Number</a>
				</li>
				<li>
				   <a href="{{ route('home.newdriverlicense') }}"><i class="bx bx-right-arrow-alt"></i>New Driver License</a>
				</li>
				<li>
				   <a href="{{ route('home.driverslicenserenewal') }}"><i class="bx bx-right-arrow-alt"></i>Drivers License Renewal</a>
				</li>
				<li>
