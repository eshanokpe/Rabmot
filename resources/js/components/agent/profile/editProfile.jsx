...
export default function EditProfile() {
    ...
    useEffect(() => {
        const fetchUserDetails = async () => {
            try {
                const response = await axios.get(`${url}/agent/get-user-details`);
                setUserDetails({
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`${url}/agent/update-profile`, formData, {
            headers: {
...
if (document.getElementById('agentEditProfile')) {
    ReactDOM.createRoot(document.getElementById('agentEditProfile')).render(
        <React.StrictMode>
            <EditProfile />
        </React.StrictMode>
    );
