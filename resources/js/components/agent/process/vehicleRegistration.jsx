...
export default function VehicleRegistration() {
    ...
    useEffect(() => {
        setVehicleList([]);
        axios
            .post(`${url}/agent/vehicleRegistration-vehicleCategoryId-selection`, {
                vehicleCategoryId,
                stateId
            })
            .then(response => {
    ...
    const handleAddVehicleChange = (event) => {
        ...
        if (addVehicleValue === "add-registration") {
            window.location.href = `${url}/agent/addvehicleregistration`;
        } 
    };
    ...
    useEffect(() => {
        axios.get(`${url}/agent/get-user-add-vehicles-registration`)
            .then(response => {
    ...
    useEffect(() => {
        const sendVehicleRegCost = () => {
            ...
            axios.post(`${url}/agent/vehicleRegistration-addVehicleRegCost`, {
                stateId,
                vehicleCategoryId,
                addVehicleReg,
                vehicleResType,
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`${url}/agent/post-vehicleRegistration`, {
            stateId:stateId,
            ownerId:userId,
            userType:'agent',
...
if (document.getElementById('agentVehicleRegistration')) {
    ReactDOM.createRoot(document.getElementById('agentVehicleRegistration')).render(
        <React.StrictMode>
            <VehicleRegistration />
        </React.StrictMode>
    );
