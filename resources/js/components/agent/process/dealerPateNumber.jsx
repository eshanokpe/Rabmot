...
export default function DealerPateNumber() {
    ...
    useEffect(() => {
        axios.get(`${url}/agent/get-state-dealerplatenumber`)
            .then(response => {
    ...
    useEffect(() => {
        // setStateList([]);
        axios
            .post(`${url}/agent/get-dealer-platenumber-price`, {
                stateId
            })
            .then(response => {
   ...
   const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${url}/agent/post/dealer/platenumber`, formData, {
                headers: {
...
if (document.getElementById('agentDealerPateNumber')) {
    ReactDOM.createRoot(document.getElementById('agentDealerPateNumber')).render(
        <React.StrictMode>
            <DealerPateNumber />
        </React.StrictMode>
    );
