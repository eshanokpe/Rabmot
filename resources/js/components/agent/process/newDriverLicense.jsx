...
export default function NewDriverLicense() {
    ...
    useEffect(() => {
        axios.get(`${url}/agent/get-state-newdriverlicense`)
            .then(response => {
    ...
    useEffect(() => {
        setLengthYearsList([]);
        axios.post(`${url}/agent/get-new-newdriverlicense-lengthYears`, {
                stateId
            })
            .then(response => {
    ...
    useEffect(() => {
        axios.post(`${url}/agent/get-new-newdriverlicense-price`, {
                stateId,
                lengthYear
            })
            .then(response => {
   ...
   const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${url}/agent/post/newdriverlicense`, formData, {
                headers: {
...
if (document.getElementById('agentNewDriverLicense')) {
    ReactDOM.createRoot(document.getElementById('agentNewDriverLicense')).render(
        <React.StrictMode>
            <NewDriverLicense />
        </React.StrictMode>
    );
