...
const [errors, setErrors] = useState({});
    ...
    useEffect(() => {
        axios.get(`${url}/agent/get-permittype-otherpermit`)
        .then(response => {
    ...
    useEffect(() => {
        axios.post(`${url}/agent/get-permittype-price`, {
            permitTypeId
        })
        .then(response => {
...
try {
        const response = await axios.post(`${url}/agent/post/otherPermit`, formData, {
            headers: {
...
if (document.getElementById('agentOtherPermit')) {
ReactDOM.createRoot(document.getElementById('agentOtherPermit')).render(
<React.StrictMode>
    <OtherPermit />
</React.StrictMode>
);
