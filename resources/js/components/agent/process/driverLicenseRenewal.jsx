...
export default function DriverLicenseRenewal() {
    ...
    useEffect(() => {
        axios.get(`${url}/agent/get-state-driverlicenserenewal`)
            .then(response => {
    ...
    useEffect(() => {
        setLengthYearsList([]);
        axios.post(`${url}/agent/get-driverlicenserenewal-lengthYears`, {
                stateId
            })
            .then(response => {
    ...
    useEffect(() => {
        axios.post(`${url}/agent/get-driverlicenserenewal-price`, {
                stateId,
                lengthYear
            })
            .then(response => {
   ...
   const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${url}/agent/post/driverlicenserenewal`, formData, {
                headers: {
...
if (document.getElementById('agentDriverLicenseRenewal')) {
    ReactDOM.createRoot(document.getElementById('agentDriverLicenseRenewal')).render(
        <React.StrictMode>
