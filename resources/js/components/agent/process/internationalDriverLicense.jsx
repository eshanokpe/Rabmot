...
export default function InternationalDriverLicense() {
    ...
    useEffect(() => {
        axios.get(`${url}/agent/get-state-internationaldriverlicense`)
            .then(response => {
    ...
    useEffect(() => {
        setLengthYearsList([]);
        axios.post(`${url}/agent/get-internationaldriverlicense-lengthYears`, {
                stateId
            })
            .then(response => {
    ...
    useEffect(() => {
        axios.post(`${url}/agent/get-internationaldriverlicense-price`, {
                stateId,
                lengthYear
            })
            .then(response => {
   ...
   const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${url}/agent/post/internationaldriverlicense`, formData, {
                headers: {
...
if (document.getElementById('agentInternationalDriverLicense')) {
    ReactDOM.createRoot(document.getElementById('agentInternationalDriverLicense')).render(
        <React.StrictMode>
