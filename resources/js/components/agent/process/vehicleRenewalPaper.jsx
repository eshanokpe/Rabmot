...
export default function AgentVehicleRenewalPaper() {
    ...
    useEffect(() => {
        setVehicleList([]);
        axios
            .post(`${url}/agent/vehicleRenewal-vehicleCategoryId-selection`, {
                vehicleCategoryId,
                stateId
            })
            .then(response => {
    ...
    const handleAddVehicleChange = (event) => {
        ...
        if (addVehicleValue === "add-renewal") {
            window.location.href = `${url}/agent/addvehiclerenewal`;
        } else if (addVehicleValue !== "") {
            console.log('Selected vehicle ID:', addVehicleValue);
            axios.post(`${url}/agent/vehicleRenewal-addVehicleValue-selection`, {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`${url}/agent/post-vehicleRenewal`, {
            stateId:stateId,
            userId:userId,
            userType:'agent',
            vehicleCategoryId: vehicleCategoryId,
